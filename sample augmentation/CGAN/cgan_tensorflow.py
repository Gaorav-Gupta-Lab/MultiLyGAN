...
if not os.path.exists('cgan_loss/'):
    os.makedirs('cgan_loss/')
if not os.path.exists('cgan_augmented_data/'):
    os.makedirs('cgan_augmented_data/')
loss_file_name = 'cgan_loss/cgan_loss_'+str(win)+'.csv'
time_cost_file_name = 'cgan_loss/cgan_time_'+str(win)+'.txt'
res_file_name = 'cgan_augmented_data/cgan_augmented_data_'+str(win)+'.csv'
